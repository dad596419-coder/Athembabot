...
TELEGRAM_BOT_TOKEN = '8804073515:AAEOm7tNX7f1TsrmHn6J1FunYB6tI2bQyF4
ADMIN_USER_ID = 5808705097
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        "*🔥 Welcome to the Athemba Devaloper! 🔥*\n\n"
        "*athemba /attack <ip> <port> <duration>*\n"
        "*Let the war begin! ⚔️💥*"
    )
